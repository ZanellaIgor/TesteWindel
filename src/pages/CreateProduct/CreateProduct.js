...
import { Heading, FormLabel, Input, Box, FormControl, Button, Flex, Alert, AlertIcon } from '@chakra-ui/react'
            ...
            <Flex
                ...
                <form
                    ...
                    <FormControl
                        display='flex'
                        justifyContent="space-between">
                        <Button alignSelf="flex-end" type='button' onClick={handleClickForm} colorScheme='green'>Criar</Button>
                    </FormControl>
                </form>
            </Flex>
